...
class ControllerCatalogInformation extends Controller { 
	...
	private function getList() {
		...
		$information_total = $this->model_catalog_information->getTotalInformationsType($type);
		...
		$this->data['heading_title'] = $this->language->get('heading_title_'.$type);
	...
	private function getForm() {
		...
		$this->data['entry_anons'] = $this->language->get('entry_anons');
		...
		$this->data['heading_title'] = $this->language->get('heading_title_'.$this->data['type']);
		...
		if (isset($this->request->post['name'])) {
			...
			$this->data['name'] = $information_info['name'];
		} else {
			$this->data['name'] = '';
		}
        ...
        // (+) ALNAUA 091114 (START)
        if (isset($this->request->post['parent_information_id'])) {
			$this->data['parent_information_id'] = $this->request->post['parent_information_id'];
		} elseif (isset($information_info)) {
			$this->data['parent_information_id'] = $information_info['parent_information_id'];
		} else {
			$this->data['parent_information_id'] = 0;
		}
        
        $this->data['informations'] = $this->model_catalog_information->getParentInformations();
