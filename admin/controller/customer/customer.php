   ...
   // 141208 ET-141208 End
       ...
       if (isset($this->request->get['filter_newsletter'])) {
        ...
        foreach ($results as $result) {
            ...
            $this->data['customers'][] = array(
                ...
                // 141208 ET-141208 Begin
                //'name'        => $result['name'],
                'name'        => html_entity_decode(str_replace('&amp;amp;', '&amp;', str_replace('amp;quot;', 'quot;', $result['name'])), ENT_QUOTES, 'UTF-8'),
                // 141208 ET-141208 End
                'email'       => $result['email'],
        ...
        // 141208 ET-141208 Begin
        $this->data['sort_newsletter'] = $this->url->https('customer/customer&sort=newsletter' . $url);
        // 141208 ET-141208 End
    ...
    public function activate() {
      ...
      private function validateForm() {
        ...
        if ((strlen(utf8_decode($this->request->post['firstname'])) < 1) || (strlen(utf8_decode($this->request->post['firstname'])) > 255)) {
        // 141208 ET-141208 End
    ...
    public function download() {
        if ($this->validateDelete()) {
            ...
            return $this->model_customer_customer->downloadCustomers($data);
        } else {
            // return a HTTP 404 error
            return $this->forward('error/not_found', 'index');
        }
    }
    // 141208 ET-141208 End
}
