...
class ControllerModuleLiqPay extends Controller {
	...
	public function index() {
		$this->load->language('module/liqpay');
		...
		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => $this->url->https('module/liqpay'),
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
				
		$this->data['action'] = $this->url->https('module/liqpay');
		...
		$this->template = 'module/liqpay.tpl';
		$this->children = array(
			'common/header',	
			'common/footer'	
		);
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/liqpay')) {
