...
class ModelDesignBanner extends Model {
 public function addBanner($data) {
  ...
  $this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', position = '" . $this->db->escape($data['position']) . "', view_type = '" . $this->db->escape($data['view_type']) . "'");
 ...
 public function editBanner($banner_id, $data) {
  ...
  $this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', position = '" . $this->db->escape($data['position']) . "', view_type = '" . $this->db->escape($data['view_type']) . "' WHERE banner_id = '" . (int)$banner_id . "'");
  // 140408 ET-140408 End
