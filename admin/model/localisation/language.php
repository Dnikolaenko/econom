...
class ModelLocalisationLanguage extends Model {
	...
	public function deleteLanguage($language_id) {
        ...
        // (+) ALNAUA 091114 (START)
        $this->db->query("DELETE FROM " . DB_PREFIX . "advcategory_description WHERE language_id = '" . (int)$language_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "advice_description WHERE language_id = '" . (int)$language_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "color_description WHERE language_id = '" . (int)$language_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "techparam_description WHERE language_id = '" . (int)$language_id . "'");
