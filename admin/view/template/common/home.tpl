...
<?php /*<div class="tabs"><a tab="#tab_sale"><?php echo $tab_stats; ?></a><a tab="#tab_order"><?php echo $tab_order; ?></a><a tab="#tab_customer"><?php echo $tab_customer; ?></a></div>*/ ?>
<div class="tabs"><a tab="#tab_order"><?php echo $tab_order; ?></a></div>
<?php /*
  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr class="<?php echo $class; ?>">
        ...
        <td class="right" style="white-space: nowrap;"><?php foreach ($order['action'] as $action) { ?>
