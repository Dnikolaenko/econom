  ...
  <table class="list">
    <thead>
      <tr>
        ...
        <td class="left"><?php if ($sort == 'email') { ?>
          ...
          <?php } ?></td>
        <?php /* <td class="left"><?php if ($sort == 'status') { ?>
    ...
    <tbody>
      <tr class="filter">
        ...
        <?php /* <td><select name="filter_status">
            <option value="*"></option>
      ...
      <tr class="<?php echo $class; ?>">
        ...
        <?php /* <td class="left"><?php echo $customer['status']; ?></td> */ ?>
...
function exportCustomers() {
    url = 'index.php?route=customer/customer/download';
