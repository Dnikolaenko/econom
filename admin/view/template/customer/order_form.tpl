...
<div class="heading">
  ...
  <div class="buttons"><a onclick="window.open('<?php echo $prepayment_invoice; ?>');" class="button"><span class="button_left button_invoice"></span><span class="button_middle"><?php echo $button_prepayment_invoice; ?></span><span class="button_right"></span></a><a onclick="window.open('<?php echo $invoice; ?>');" class="button"><span class="button_left button_invoice"></span><span class="button_middle"><?php echo $button_invoice; ?></span><span class="button_right"></span></a><a onclick="location='<?php echo $cancel; ?>';" class="button"><span class="button_left button_back"></span><span class="button_middle"><?php echo $button_back; ?></span><span class="button_right"></span></a></div>
 <!-- <div class="buttons"><a onclick="window.open('<?php echo $prepayment_nds_invoice; ?>');" class="button"><span class="button_left button_invoice"></span><span class="button_middle"><?php echo $button_prepayment_invoice; ?></span><span class="button_right"></span></a><a onclick="window.open('<?php echo $invoices; ?>');" class="button"><span class="button_left button_invoice"></span><span class="button_middle"><?php echo $button_invoice; ?></span><span class="button_right"></span></a></div> -->
</div>
<div id="order">
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table>
      <thead>
        <tr>
          <td align="center" colspan="5"><?php echo $text_order_details; ?></td>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td width="20%"><b><?php echo $text_order; ?></b></td>
          <td width="20%"><b><?php echo $text_date_added; ?></b></td>
          <td width="20%"><b><?php echo $text_payment_method; ?></b></td>
          <td width="20%"><b><?php echo $text_shipping_method; ?></b></td>
          <td width="20%"><b><?php echo $text_credit; ?></b></td>
        </tr>
        <tr>
    ...
    <?php if($totals['0']['val_nds'] > 0){ ?>  
      <tr>
          <td align="center" colspan="5">   <h3>Заказ с НДС</h3> </td> 
    </tr>
      <tbody>
        <tr>
        ...
        <?php foreach ($totals as $total) { ?>
                <?php } ?>
        <tr>
            <td align="right" colspan="4"><b><?php echo $totals['0']['title']; ?></b></td>
            <td align="right"><?php echo number_format($totals['0']['val_nds'], 2, '.', ''); ?> грн</td>
        </tr>
        <tr>
            <td align="right" colspan="4"><b><?php echo $totals['1']['title']; ?></b></td>
            <td align="right"><?php echo number_format($totals['1']['value'], 2, '.', ''); ?> грн</td>
        </tr>
        <tr>
            <td align="right" colspan="4"><b><?php echo $totals['2']['title']; ?></b></td>
            <td align="right"><?php echo number_format($totals['2']['value'], 2, '.', ''); ?> грн</td>
        </tr>
        <tr>
            <td align="right" colspan="4"><b><?php echo $totals['3']['title']; ?></b></td>
            <td align="right"><?php echo number_format($totals['1']['val_nds']+$totals['2']['value']-$totals[1]['value'], 2, '.', ''); ?> грн</td>
        </tr>
      </tbody>
      <?php } ?>
      <?php if ($totals['0']['val_no_nds'] > 0) { ?>
      <tbody>
          <tr>
              <td align="center" colspan="5"> <h3>Заказ без НДС</h3> </td>
      </tr>   
                <tr>
          <td><b><?php echo $column_product; ?></b></td>
          <td><b><?php echo $column_model; ?></b></td>
    ...
    <?php } ?>
    <?php if($totals['0']['val_nds'] == 0 && $totals['0']['val_no_nds'] == 0)  { ?>
    <tbody>
        <tr>
          <td><b><?php echo $column_product; ?></b></td>
          <td><b><?php echo $column_model; ?></b></td>
