<?php 
class ControllerCommonPageone extends Controller { 
...
//   $this->data['pay'] = $pay; # вывод формы
  ...
  if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/pageone.tpl')) {
   $this->template = $this->config->get('config_template') . '/template/common/pageone.tpl';
  } else {
   $this->template = 'default/template/common/pageone.tpl';
  }
