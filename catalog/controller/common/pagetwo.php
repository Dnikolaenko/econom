<?php 
class ControllerCommonPagetwo extends Controller { 
...
//   $this->data['pay'] = $pay; # вывод формы
  ...
  if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/pagetwo.tpl')) {
   $this->template = $this->config->get('config_template') . '/template/common/pagetwo.tpl';
  } else {
   $this->template = 'default/template/common/pagetwo.tpl';
  }
