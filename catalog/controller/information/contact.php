...
class ControllerInformationContact extends Controller {
 private $error = array(); 
  ...
  $this->language->load('information/contact');
        ...
        $this->document->title = ($this->config->get('config_contacts_title') != '' ? $this->config->get('config_contacts_title') : $this->language->get('heading_title'));
        $this->document->description = $this->config->get('config_contacts_meta_description');
        $this->document->keywords = $this->config->get('config_contacts_meta_keywords');
   ...
   $mail->setTo($this->config->get('config_email'));
     ...
     $this->data['text_fax'] = $this->language->get('text_fax');
        // (+) ALNAUA 091114 (START)
        $this->data['text_schema'] = $this->language->get('text_schema');
...
//  $this->data['store'] = $this->config->get('config_store');
     ...
     //$this->data['telephone'] = $this->config->get('config_telephone');
        $this->data['telephone'] = preg_replace('/,\s+/i', '<br />', $this->config->get('config_telephone'));
        $this->data['email'] = nl2br($this->config->get('config_email'));
        // (+) ALNAUA 091114 (FINISH)
     $this->data['fax'] = $this->config->get('config_fax');
     
     $this->data['contacts_extra'] = html_entity_decode($this->config->get('config_contacts_extra_' . $this->language->getId()));
