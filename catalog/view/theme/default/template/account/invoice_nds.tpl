...
<div id="content">
  <div class="middle">
    ...
    <div class="buttons">
      <table>
        <tr>
          <td align="left" width="35%"><a onclick="window.open('<?php echo $prepayment_nds_invoice; ?>');" class="button"><span><?php echo $button_prepayment_invoice; ?></span></a></td>
          <td align="center" width="20%"><a onclick="window.open('<?php echo $nds_invoice; ?>');" class="button"><span><?php echo $button_invoice; ?></span></a></td>
          <?php if (isset($data)) { ?>
