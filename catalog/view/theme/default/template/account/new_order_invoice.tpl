...
<table class="product">
  ...
  <tr>
    ...
    <td align="right"><?php echo number_format($totals['0']['val_no_nds'], 2, '.', ''); ?></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td align="right"><?php echo number_format($totals['3']['val_no_nds']-$totals['1']['value'], 2, '.', ''); ?></td>
  </tr>
  <?php } else { ?>
  <tr>
    <td align="right" colspan="6"><b><?php echo $totals['2']['title']; ?></b></td>
  ...
  <tr>
    <td align="right" colspan="6"><b><?php echo $totals['3']['title']; ?></b></td>
    <td align="right"><?php echo number_format($totals['3']['val_no_nds']+$totals['2']['value']-$totals['1']['value'], 2, '.', ''); ?></td>
  </tr>
  <?php } ?>
</table>
