<div style='display:none'>
  ...
  <div class='contact-content'>
    ...
    <form action='#' method="get" style='display:none'>
      ...
      <label for='contact-phone'>* <?php echo $text_click_phone; ?></label>
      <input type='text' id='contact-phone' class='contact-input' name='phone' tabindex='1002' />
      <?php if ($settings['callback_time']) { ?>
      <label for='contact-subject'><?php echo $text_click_callback_time; ?></label>
      ...
      <label for='contact-message'>* <?php echo $text_click_message; ?></label>
      <textarea id='contact-message' class='contact-input' name='message' cols='20' rows='4' tabindex='1004'></textarea>
      <?php } ?>
      <br/>
      <label>&nbsp;</label>
      <button type='submit' class='contact-send contact-button' tabindex='1006'><?php echo $text_click_button_send; ?></button>
      <button type='submit' class='contact-cancel contact-button simplemodal-close' tabindex='1007'><?php echo $text_click_button_cancel; ?></button>
      <br/>
